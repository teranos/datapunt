...
in
{
  # `identity` is the field every subject of this kind carries, and the one a
  # roll call goes through. Without it a subject missing some arbitrary field
  # does not appear in coverage at all.
  competitor = {
    identity = "url";
